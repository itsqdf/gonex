...
export default function EditCompanyPage() {
  ...
  useEffect(() => {
    if (!token || !id) return;
    fetch(`${API_URL}/companies/${id}`, { headers: { Authorization: `Bearer ${token}` } })
      .then((r) => r.json())
      .then((data) => setCompany((data.company || data) as Company))
      .catch(() => {});
  }, [id, token]);
        ...
        <form onSubmit={save} className="rounded-2xl bg-white/80 backdrop-blur border border-white/60 p-6 shadow space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="relative z-0">
              <input type="text" id="nama" value={company.nama} onChange={(e)=>setCompany({ ...(company as any), nama: e.target.value })} placeholder=" " autoComplete="off" className="block w-full px-3 pb-2.5 pt-5 text-sm text-gray-900 bg-white rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent peer" required />
            ...
            {/* Label */}
            <div className="relative z-0">
              <input type="text" id="label" value={company.label} onChange={(e)=>setCompany({ ...(company as any), label: e.target.value })} placeholder=" " autoComplete="off" className="block w-full px-3 pb-2.5 pt-5 text-sm text-gray-900 bg-white rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent peer" />
            ...
            {/* Kota */}
            <div className="relative z-0">
              <input type="text" id="kota" value={company.kota} onChange={(e)=>setCompany({ ...(company as any), kota: e.target.value })} placeholder=" " autoComplete="off" className="block w-full px-3 pb-2.5 pt-5 text-sm text-gray-900 bg-white rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent peer" />
            ...
            {/* Provinsi */}
            <div className="relative z-0">
              <input type="text" id="provinsi" value={company.provinsi} onChange={(e)=>setCompany({ ...(company as any), provinsi: e.target.value })} placeholder=" " autoComplete="off" className="block w-full px-3 pb-2.5 pt-5 text-sm text-gray-900 bg-white rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent peer" />
            ...
            {/* Kode */}
            <div className="relative z-0">
              <input type="text" id="kode" value={company.kode} onChange={(e)=>setCompany({ ...(company as any), kode: e.target.value })} placeholder=" " autoComplete="off" className="block w-full px-3 pb-2.5 pt-5 text-sm text-gray-900 bg-white rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent peer" />
            ...
            {/* CEO */}
            <div className="relative z-0">
              <input type="text" id="ceo" value={company.ceo} onChange={(e)=>setCompany({ ...(company as any), ceo: e.target.value })} placeholder=" " autoComplete="off" className="block w-full px-3 pb-2.5 pt-5 text-sm text-gray-900 bg-white rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent peer" />
            ...
            {/* Sejak */}
            <div className="relative z-0">
              <input type="text" id="since" value={company.since} onChange={(e)=>setCompany({ ...(company as any), since: e.target.value })} placeholder=" " autoComplete="off" className="block w-full px-3 pb-2.5 pt-5 text-sm text-gray-900 bg-white rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent peer" />
            ...
            {/* Nomor */}
            <div className="relative z-0">
              <input type="text" id="nomor" value={company.nomor} onChange={(e)=>setCompany({ ...(company as any), nomor: e.target.value })} placeholder=" " autoComplete="off" className="block w-full px-3 pb-2.5 pt-5 text-sm text-gray-900 bg-white rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent peer" />
            ...
            <div className="relative z-0 md:col-span-2">
              <input type="text" id="alamat" value={company.alamat} onChange={(e)=>setCompany({ ...(company as any), alamat: e.target.value })} placeholder=" " autoComplete="off" className="block w-full px-3 pb-2.5 pt-5 text-sm text-gray-900 bg-white rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent peer" />
            ...
            {/* Signature */}
            <div className="relative z-0">
              <input type="text" id="signature" value={company.signature} onChange={(e)=>setCompany({ ...(company as any), signature: e.target.value })} placeholder=" " autoComplete="off" className="block w-full px-3 pb-2.5 pt-5 text-sm text-gray-900 bg-white rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent peer" />
            ...
            {/* Stamp */}
            <div className="relative z-0">
              <input type="text" id="stamp" value={company.stamp} onChange={(e)=>setCompany({ ...(company as any), stamp: e.target.value })} placeholder=" " autoComplete="off" className="block w-full px-3 pb-2.5 pt-5 text-sm text-gray-900 bg-white rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent peer" />
          ...
          <div className="flex justify-end gap-2 pt-2">
            {/* Batal */}
            <button type="button" onClick={() => router.push(`/dashboard/admin/companies`)} className="text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 inline-flex items-center gap-2" aria-label="Batal" title="Batal">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" /></svg>
              <span>Batal</span>
            </button>
            {/* Simpan */}
            <button type="submit" disabled={saving} className="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 disabled:opacity-60 disabled:cursor-not-allowed inline-flex items-center justify-center gap-2" aria-label="Simpan" title="Simpan">
              {saving ? (
